...
<div id="small-boi">
    <a href="https://github.com/thegabe101/Project-1-Rainer-Matt-Ming-Gabe" class="project-link" alt="Dog-4-U">
        <header>Nature Excursions</header>
...
<div id="small-boi">
    <a href="https://github.com/hoeferm2/E-commerce-back-end-build" class="project-link" alt="Social Emotional Learning">
        ...
        <img src=".\assets\images\sad.jpg" alt="Male experiencing sadness" />
    </a>
</div>
<div id="small-boi">
    <a href="https://hoeferm2.github.io/password-debug-challenge/" class="project-link" alt="Password Generator">
        ...
        <img src=".\assets\images\matt.jpg" alt="Password Generator." />
    </a>
</div>
<div id="small-boi">
    <a href="https://techque-deque-blog.herokuapp.com/" class="project-link" alt="Tech blog">
        <header>Tech blog</header>
        <img src=".\assets\images\matt.jpg" alt="Tech blog." />
    </a>
</div>
<div id="small-boi">
    <a href=".\assets\images\matt.jpg" class="project-link" alt="Cultural Exchanges">
        <header>Cultural Exchanges</header>
        <img src=".\assets\images\matt.jpg" alt="Two people of different cultures sharing tea." />
    </a>
</div>
</div>
    </div>
